...
return (
  <footer className="bg-[#20263e] text-gray-300 border-t border-gray-700 pt-2 pb-4 mt-5">
    <div className="container mx-auto px-4 mb-2">
      <div className="flex flex-col md:flex-row justify-between pt-4">
        ...
        <div>
          ...
          <p>
            Phone:{" "}
            <span className="hover:text-gray-400">+91 (55) 123-4567</span>
          </p>
        </div>
      </div>

      <div className="flex flex-col md:flex-row justify-between items-center mt-3 border-t border-gray-700 ">
        <div className="mb-2 md:mb-0">
          <h2 className="text-xl font-bold text-white">SkillCareer</h2>
          <p className="text-sm">© 2024 Your Company. All rights reserved.</p>
        </div>
